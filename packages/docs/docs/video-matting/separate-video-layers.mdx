...
# separateVideoLayers()<AvailableFrom v="4.0.522" />
...
Use [`getAvailableVideoMattingModels()`](/docs/video-matting/get-available-video-matting-models) to inspect the available models.
